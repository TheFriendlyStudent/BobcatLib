 ...
 * This class provides standardized access to joystick axes and button triggers for the Xbox controller.
 */
public class XboxControllerWrapper extends CommandXboxController implements ControllerWrapper {
    ...
    /**
     * Constructs an Xbox controller wrapper for the specified port.
     * The wrapper includes access to left and right joysticks, POV controls, and button mappings (Y, B, A, X).
     *
