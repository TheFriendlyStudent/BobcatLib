 ...
 * This interface defines methods for updating sensor inputs, setting and retrieving gyro data, 
 * and performing periodic updates.
 */
public interface GyroIO {

  /**
   * Represents the inputs for the gyro sensor.
   * This class stores data about the gyro's connection status, orientation (yaw, pitch, roll), 
   * and fault status.
   */
   ...
   * This method is called to refresh the gyro's internal data.
   *
  ...
  /**
   * Gets the time difference between the last and current sensor update.
   * This can be used to track the time between periodic updates.
   * 
  ...
  /**
   * Periodically updates the gyro sensor's data for a Pigeon2 device.
   * This method should be called regularly to update the gyro's state.
   *
  ...
  /**
   * Periodically updates the gyro sensor's data.
   * This method should be called regularly to update the gyro's state.
   */
