...
/**
 * The BaseGyro class provides an abstraction for interacting with a gyro sensor.
 * It communicates with the underlying GyroIO interface to retrieve and set orientation
 * data (yaw, pitch, and roll) and periodically updates sensor inputs.
 */
public class BaseGyro {
    ...
    /**
     * Periodically updates the sensor inputs from the GyroIO interface.
     * This should be called regularly to refresh the gyro's data.
     */
    ...
    /**
     * Retrieves the time difference between the last and current sensor update.
     * This can be useful for determining how much time has passed between updates.
     * 
