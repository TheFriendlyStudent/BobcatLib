...
/**
 * A base class for interacting with an encoder using the {@link EncoderIO} interface.
 * This class provides methods for configuring the encoder, retrieving its position,
 * and managing faults.
 */
public class BaseEncoder {
    ...
    /**
     * Periodically updates the encoder's inputs.
     * This method should be called regularly to ensure accurate data.
     */
     ...
     * This method ensures the encoder is properly initialized for absolute position tracking.
     */
     ...
     *
     * @return the absolute position in rotations, represented as a value in the range (-1 to 0) or (0 to 1).
     */
     ...
     * Sticky faults are errors that persist until explicitly cleared.
     */
    ...
    /**
     * Checks the encoder for faults and handles them as necessary.
     * This method is called internally after critical operations.
     */
