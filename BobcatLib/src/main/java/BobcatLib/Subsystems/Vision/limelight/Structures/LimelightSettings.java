...
public class LimelightSettings {
  ...
  /** {@link LimelightCamera} PipelineIndex to use. */
  ...
  /** LED Mode for the {@link LimelightCamera}. */
  public enum LEDMode {
    PipelineControl,
    ForceOff,
    ForceBlink,
  ...
  /** Stream mode for the {@link LimelightCamera} */
  ...
  /** Downscaling Override Enum for {@link LimelightCamera} */
