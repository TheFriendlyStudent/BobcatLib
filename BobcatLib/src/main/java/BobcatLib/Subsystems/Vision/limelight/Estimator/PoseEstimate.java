...
public class PoseEstimate {
  ...
  /** {@link LimelightCamera} to use. */
  private final LimelightCamera limelight;
  /** {@link LimelightCamera} Pose Entry name to use. */
  ...
  /** {@link LimelightCamera} Pose Entry NetworkTables. */
  private DoubleArrayEntry poseEntry;

  /**
   * Construct the {@link PoseEstimate} from the limelight entry in NT.
   *
   * @param camera {@link LimelightCamera} to fetch the data from.
