package BobcatLib.Subsystems.Swerve.AdvancedSwerve.Swerve.Module.Utility.Pose;
...
public class BobcatPoseEstimator implements PoseLib {
    ...
    public BobcatPoseEstimator(
        ...
        Pose2d initPose) {
      swerveDrivePoseEstimator = new SwerveDrivePoseEstimator(swerveKinematics, yaw, modulePositions, initPose,SwerveConstants.autostateStdDevs, VecBuilder.fill(0, 0, 0));
    }
    ...
    public void addVisionMeasurement(Pose2d botPoseMG2, double poseTimestampMG2, Matrix<N3,N1> stdDev) {
        swerveDrivePoseEstimator.addVisionMeasurement(botPoseMG2, poseTimestampMG2, stdDev);
    }
  }
