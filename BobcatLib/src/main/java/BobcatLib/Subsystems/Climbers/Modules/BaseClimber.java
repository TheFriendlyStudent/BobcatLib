...
public class BaseClimber {
    ...
    /**
     * Constructs a {@code ClimberSubsystem} with the specified name and
     ...
     *
     * <p>
     * This method is called regularly by the scheduler to update telemetry and
     * control logic. It
     * also uses AdvantageKit's {@link Logger} to log the climber's inputs for
     * diagnostics.
     */
     ...
     *
     * @param percent The desired output percentage, where 1.0 represents full
     *                forward power and -1.0
     ...
     *
     * @param position The desired position of the climber as a {@link Rotation2d}
     *                 object.
     */
