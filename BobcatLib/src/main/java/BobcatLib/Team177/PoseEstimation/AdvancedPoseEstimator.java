 ...
 * AdvancedPoseEstimator#addVisionMeasurement} and only call {@link AdvancedPoseEstimator#update} then this will
 * behave exactly the same as Odometry.
 *
 * <p>{@link AdvancedPoseEstimator#update} should be called every robot loop.
 *
 * <p>{@link AdvancedPoseEstimator#addVisionMeasurement} can be called as infrequently as you want; if you
 * never call it then this class will behave exactly like regular encoder odometry.
 *
 * @param <T> Wheel positions type.
 */
public class AdvancedPoseEstimator<T> {
  ...
  /**
   * Sets the pose estimator's trust of odometry measurments. This might be used to change trust in
   * odometry measurements after the autonomous period, or to change trust as acceleration increases.
   *
   * @param visionMeasurementStdDevs Standard deviations of the odometry measurements. Increase these
   *     numbers to trust global measurements from odometry less. This matrix is in the form [x, y,
   ...
   * AdvancedPoseEstimator#update} every loop.
   *
   ...
   *     AdvancedPoseEstimator#updateWithTime(double,Rotation2d,Object)} then you must use a timestamp with
   ...
   * AdvancedPoseEstimator#setVisionMeasurementStdDevs(Matrix)} or this method.
   *
   * @param visionRobotPoseMeters The pose of the robot as measured by the vision camera.
   * @param timestampSeconds The timestamp of the vision measurement in seconds. Note that if you
